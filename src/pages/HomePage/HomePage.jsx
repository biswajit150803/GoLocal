        ...
        {success ? (
          ...
          <>
            <Modal
              ...
              center={true}
              closeIcon={
                <RxCross2 style={{ color: "white", fontSize: "25px" }} />
              }
            >
              <div className="moddd">
                <div className="mod-top">
                  For better User Experience, Please Specify whether you are
                  here for Business or as a Customer
                </div>
                ...
                >
                  <button onClick={handleRedirect} className="mod_button">
                    Go
                  </button>
                </div>
              </div>
